<?php
    /*
       echoe printsao mais ou menos iguais. Ambos sao usados 
​​       para enviar dados para a tela.As diferencas sao pequenas: 
       echo nao tem valor de retorno enquanto printtem valor de retorno 1
       para que possa ser usado em expressoes
    */
    ...
    echo $x;
    echo "<h1>Hello World</h1>"; //echo pode contem HTML
